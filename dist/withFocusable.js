...
var withFocusable = (0, _compose3.default)(_withSpatialNavigationContext.getSpatialNavigationContext, (0, _getContext3.default)({
  /**
   * From the context provided by another higher-level 'withFocusable' component
   */
  parentFocusKey: _propTypes2.default.string
}), (0, _withStateHandlers3.default)(function (_ref) {
  var focusKey = _ref.focusKey,
      _ref$setFocus = _ref.setFocus,
      setFocus = _ref$setFocus === undefined ? _noop3.default : _ref$setFocus;
...
}, {}), (0, _mapProps3.default)(function (_ref2) {
  var currentFocusKey = _ref2.currentFocusKey,
      parentsHavingFocusedChild = _ref2.parentsHavingFocusedChild,
      realFocusKey = _ref2.realFocusKey,
      props = _objectWithoutProperties(_ref2, ['currentFocusKey', 'parentsHavingFocusedChild', 'realFocusKey']);
...
(0, _withContext3.default)({
  ...
  onEnterPressHandler: function onEnterPressHandler(_ref4) {
    var _ref4$onEnterPress = _ref4.onEnterPress,
        onEnterPress = _ref4$onEnterPress === undefined ? _noop3.default : _ref4$onEnterPress;
    return onEnterPress;
  },
  onBecameFocusedHandler: function onBecameFocusedHandler(_ref5) {
    var _ref5$onBecameFocused = _ref5.onBecameFocused,
        onBecameFocused = _ref5$onBecameFocused === undefined ? _noop3.default : _ref5$onBecameFocused;
